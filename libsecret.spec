...
Source0  : https://download.gnome.org/sources/libsecret/0.20/libsecret-0.20.3.tar.xz
...
%prep
%setup -q -n libsecret-0.20.3
cd %{_builddir}/libsecret-0.20.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588038463
...
cp %{_builddir}/libsecret-0.20.3/COPYING %{buildroot}/usr/share/package-licenses/libsecret/7c7d178d9ce31b21a4869940a881b043b086f007
cp %{_builddir}/libsecret-0.20.3/COPYING.TESTS %{buildroot}/usr/share/package-licenses/libsecret/22e01c37d5bbe7f728acd042bb9d6972081bfb48
%make_install
%find_lang libsecret
